...
#1.1 加载数据
#观察样本数量和稀疏度
df = pd.read_csv(r'C:\Users\26371\Desktop\图书推荐系统\data\train_dataset.csv')
hf = pd.read_csv(r'C:\Users\26371\Desktop\图书推荐系统\data\test_dataset.csv')
...
# 模型保存
torch.save(model.state_dict(), r'C:\Users\26371\Desktop\图书推荐系统\模型\model.h5')    
...
df = pd.read_csv(r'C:\Users\26371\Desktop\图书推荐系统\data\test_dataset.csv')
...
f = open(r'C:\Users\26371\Desktop\图书推荐系统\data\submission.csv', 'w', encoding='utf-8')
...
#最后给每个用户推荐10本书，在submission.csv文件里查看